...
export default function DashboardHeader({ user, onMenu }: DashboardHeaderProps) {
  ...
  return (
    <header className="backdrop-blur-xl bg-white/80 dark:bg-slate-900/70 border-b border-slate-200/80 dark:border-slate-800 px-4 md:px-6 py-3 flex items-center justify-between gap-3 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-2 md:gap-3">
        <button
          ...
          className="hidden md:flex items-center gap-2 text-xs border border-slate-200 dark:border-slate-700 px-2.5 py-1.5 rounded-lg text-slate-500 bg-white/70 dark:bg-slate-900/50"
