...
function MainDashboardShell({ user, children }: Omit<DashboardShellProps, 'siteVariant'>) {
  ...
  return (
    <div className="flex h-screen bg-[#F9FAFB] text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <Sidebar user={user} mobileOpen={mobileOpen} onCloseMobile={() => setMobileOpen(false)} />
      <div className="relative flex flex-1 flex-col overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_0%,rgba(0,196,180,0.12),transparent_34%),radial-gradient(circle_at_90%_18%,rgba(13,58,92,0.12),transparent_30%)] dark:bg-[radial-gradient(circle_at_18%_0%,rgba(0,196,180,0.12),transparent_34%),radial-gradient(circle_at_90%_18%,rgba(255,255,255,0.05),transparent_30%)]" />
