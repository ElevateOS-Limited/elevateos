    ...
    <div className="grid gap-4 xl:grid-cols-[1.3fr_.9fr]">
        ...
        <div className="rounded-[1.5rem] border border-slate-900/10 bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h1 className="font-display mt-4 text-3xl tracking-tight text-slate-950">Recent session summaries</h1>
              <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-600">
                Keep tutor notes ready for a parent update, a follow-up message, or the next session plan. Active view: {activePov}.
              </p>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-[1.25rem] border border-slate-900/10 bg-[#f8f5ef] p-4 text-center">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Declining</p>
        ...
        <div className="space-y-3">
          {filteredStudents.map((student) => (
            ...
            >
              ...
              <p className="mt-3 text-sm leading-7 text-slate-600">{student.recap}</p>
      ...
      <aside className="space-y-4">
        <div className="rounded-[1.25rem] border border-slate-900/10 bg-white p-5 shadow-sm">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Selected recap</div>
          {selectedStudent ? (
            <div className="mt-4 space-y-4">
              ...
              <div className="rounded-[1rem] bg-[#f8f5ef] p-4 text-sm leading-7 text-slate-700">{selectedStudent.recap}</div>
              <div className="rounded-[1rem] border border-slate-900/10 p-4 text-sm leading-7 text-slate-700">
                <span className="font-semibold text-slate-950">Next note:</span> {selectedStudent.note}
              </div>
