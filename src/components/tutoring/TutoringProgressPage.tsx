    ...
    <div className="grid gap-4 xl:grid-cols-[1.05fr_.95fr]">
      <section className="space-y-4">
        <div className="rounded-[1.5rem] border border-slate-900/10 bg-white p-6 shadow-sm">
          ...
          <h1 className="font-display mt-4 text-3xl tracking-tight text-slate-950">Trend lines and intervention signals</h1>
          <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-600">
            Track growth across the roster, isolate students who need a reset, and keep the current view aligned with {activePov}.
          </p>
        ...
        <div className="rounded-[1.25rem] border border-slate-900/10 bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-slate-500">Roster trend</p>
              <h2 className="mt-1 text-xl font-semibold text-slate-950">Sorted by progress</h2>
            </div>
      ...
      <aside className="space-y-4">
        <div className="rounded-[1.25rem] border border-slate-900/10 bg-slate-950 p-5 text-white shadow-lg shadow-slate-950/10">
          <div className="text-xs font-semibold uppercase tracking-[0.18em] text-[#f2c06d]">Selected student</div>
          {selectedStudent ? (
            <div className="mt-4 space-y-4">
              ...
              <div className="rounded-[1rem] border border-white/10 bg-white/5 p-4 text-sm leading-7 text-white/75">
                <span className="font-semibold text-white">Next note:</span> {selectedStudent.note}
              </div>
            </div>
          ) : null}
        </div>
